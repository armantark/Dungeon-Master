<script lang="ts">
  import { deriveTranscriptRows, searchTranscript, type SearchMatch } from "../../lib/history";
...
{#if query.trim() === ""}
  <p class="muted search__hint">
    Search every committed beat — DM prose, your actions, engine notes. Hits jump the chat to the
    moment.
  </p>
